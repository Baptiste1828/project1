...
window.addEventListener("scroll", function () {
        ...
        if ((window.scrollY >= 800 /*&& window.scrollY <= 2700*/) && !firstFig.classList.contains("imageScroll") && window.matchMedia("(min-width: 426px)").matches) {
        ...
        if (window.scrollY >= 1350 && !secondFig.classList.contains("imageScrollBis") && window.matchMedia("(min-width: 426px)").matches) {
